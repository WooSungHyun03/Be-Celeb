...
from app.domains.video_analysis.service import SUBTITLE_ANALYSIS_DISABLED_MESSAGE, create_video_analysis_from_youtube_video, generate_storyboard_from_analysis, get_video_analysis
...
async def transcribe_video(
    ...
    try:
        ...
        if request.youtubeVideoId:
            ...
            raise BackendApiError(SUBTITLE_ANALYSIS_DISABLED_MESSAGE, 409, "SUBTITLE_ANALYSIS_DISABLED")
        else:
