...
from app.domains.calendar.controller import add_calendar_event, calendar_events, patch_calendar_event, remove_calendar_event, get_calendar_holidays
...
router.add_api_route("/holidays", get_calendar_holidays, methods=["GET"], response_model=None)
