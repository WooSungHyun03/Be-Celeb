...
class Settings(BaseSettings):
    ...
    youtube_backfill_channel_batch_size: int = 5
    youtube_backfill_concurrency: int = 1
    youtube_backfill_pages_per_channel: int = 3
    youtube_backfill_time_budget_seconds: int = 55
    youtube_backfill_lock_ttl_minutes: int = 30
