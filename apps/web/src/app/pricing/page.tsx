...
const plans = [
  {
    name: "Starter",
    price: "0원",
    description: "처음 시작하는 크리에이터를 위한 기본 플랜",
  ...
  },
  {
    ...
    features: ["AI 추천 생성 무제한", "추천 결과 복사 및 저장", "점수와 해시태그 분석", "우선 업데이트"],
    highlighted: true,
  },
  {
    name: "Team",
    price: "문의",
    description: "브랜드와 팀 작업을 위한 운영 플랜",
...
export default function PricingPage() {
  return (
    <div className="space-y-8">
      <PageHeader
        align="center"
        eyebrow={<Badge tone="brand">Pricing</Badge>}
        title="가격제와 구독 플랜"
        description="크리에이터의 현재 단계에 맞춰 가볍게 시작하고, 필요할 때 확장하세요."
      />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        {plans.map((plan) => (
          <Card
            key={plan.name}
            className={plan.highlighted ? "border-violet-300 bg-[linear-gradient(180deg,#ffffff_0%,#faf5ff_100%)] ring-2 ring-violet-100" : ""}
          >
