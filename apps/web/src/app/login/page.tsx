          ...
          <form className="mt-8 rounded-2xl border border-slate-200 bg-slate-50/70 p-5 sm:p-6" onSubmit={handleSubmit}>
            ...
            <div className="mt-5 flex flex-wrap items-center justify-between gap-3 text-sm text-slate-500">
              ...
              <div className="flex items-center gap-2">
                <Link href={ROUTES.findId} className="font-medium hover:text-ink">아이디 찾기</Link>
                <span className="text-slate-300">|</span>
                <Link href={ROUTES.forgotPassword} className="font-medium hover:text-ink">비밀번호 찾기</Link>
              </div>
            </div>
          </form>
        </section>
